...
export const th: TranslationMap = {
  ...
  config: {
    ...
    section: {
      ...
      environmentVariablesDesc: "Environment variables passed to the gateway process",
      updates: "Updates",
      updatesDesc: "Auto-update settings and release channel",
      agents: "เอเจนต์",
      agentsDesc: "Agent configurations, models, and identities",
      authentication: "Authentication",
      authenticationDesc: "API keys and authentication profiles",
      channels: "ช่องทาง",
      ...
      setupWizardDesc: "Setup wizard state and history",
      metadata: "Metadata",
      metadataDesc: "Gateway metadata and version information",
      logging: "Logging",
      ...
      diagnosticsDesc: "Instrumentation, OpenTelemetry, and cache-trace settings",
      cli: "CLI",
      cliDesc: "CLI banner and startup behavior",
      secrets: "Secrets",
      secretsDesc: "Secret provider configuration",
      acp: "ACP",
      acpDesc: "Agent Communication Protocol runtime and streaming settings",
      mcp: "MCP",
      mcpDesc: "Model Context Protocol server definitions",
      theme: "ธีม",
      wizard: "Setup Wizard",
    },
    themeRoundness: {
    ...
    theme: {
      chromaFamily: "Chroma family",
      blackRed: "Black & red",
      chocolateBlueprint: "Chocolate blueprint",
      ...
      title: "ธีม",
      chooseFamily: "Choose a theme family.",
    ...
    pushNotifications: {
      ...
      granted: "Granted",
      denied: "Denied",
      notRequested: "ไม่ได้ร้องขอ",
      unsupported: "Unsupported",
      subscribeHint: "Subscribe to receive browser push notifications from your gateway.",
    ...
    mode: {
      form: "Form",
      formTooltip: "Form view can't safely edit some fields",
      raw: "Raw",
      rawTooltip: "Edit raw JSON/JSON5 config",
      rawUnavailable: "Raw mode unavailable for this snapshot",
    },
    changes: {
      unsaved: "Unsaved changes",
      none: "No changes",
      unsavedTooltip: "{count} unsaved change(s)",
    ...
    diff: {
      ...
      noJsonDiff: "Changes detected (JSON diff not available)",
    },
    env: {
      hide: "Hide env values",
      reveal: "Reveal env values",
      peek: "Peek",
    },
    raw: {
      unsafeFields:
      ...
      secrets: "{count} secret(s) redacted/visible",
      reveal: "Reveal sensitive values",
      hide: "Hide sensitive values",
      toggleAria: "Toggle raw config redaction",
      hiddenHint:
    ...
    quick: {
      ...
      fastModeOff: "Off",
      channelsCard: "ช่องทาง",
      connected: "{count} connected",
      noChannels: "No channels configured",
      connect: "Connect →",
      automationsCard: "Automations",
      scheduledTasks: "{count} scheduled task(s)",
      manage: "Manage →",
      skillsInstalled: "{count} skill(s) installed",
      browse: "Browse →",
      mcpServers: "{count} MCP server(s)",
      configure: "Configure →",
      ...
      storedLocally: "Stored in this browser only.",
      ...
      customDescription: "This config does not currently match one of the built-in profiles.",
      customImpact:
      ...
      customReady: "Current values are custom. Choose a profile to stage a change.",
      advanced: "ขั้นสูง",
    },
    preset: {
      personal: {
